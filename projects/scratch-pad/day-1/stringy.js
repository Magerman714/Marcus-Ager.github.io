...
function beginsWith(string, char) {
    // YOUR CODE BELOW HERE //
//separate out the first character of the inputted string
var first;
...
//separate out the last character of the inputted string
var last;
...
function concat(stringOne, stringTwo) {
    // YOUR CODE BELOW HERE //
//return the two inputted strings as one string
